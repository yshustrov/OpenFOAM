...
namespace Foam
{
    ...
    makeIRReactions(gas9HThermoPhysics, LangmuirHinshelwoodReactionRate)
    makeIRReactions(gas9EThermoPhysics, LangmuirHinshelwoodReactionRate)
    
    // ************************************************************************* POWER *************************************************************************
    
    makeIRReactions(powerGasEThermoPhysics, LangmuirHinshelwoodReactionRate)
    makeIRReactions(powerGas9EThermoPhysics, LangmuirHinshelwoodReactionRate)
