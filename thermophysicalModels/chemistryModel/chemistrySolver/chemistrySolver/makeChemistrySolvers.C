...
namespace Foam
{
    ...
    makeChemistrySolverTypes(psiReactionThermo, gas9HThermoPhysics);
    makeChemistrySolverTypes
    (
        psiReactionThermo,
    ...
    makeChemistrySolverTypes(rhoReactionThermo, gas9HThermoPhysics);
    makeChemistrySolverTypes
    (
        rhoReactionThermo,
        incompressibleGas9HThermoPhysics
    ...
    makeChemistrySolverTypes(psiReactionThermo, gas9EThermoPhysics);
    makeChemistrySolverTypes
    (
        psiReactionThermo,
    ...
    makeChemistrySolverTypes(rhoReactionThermo, gas9EThermoPhysics);
    makeChemistrySolverTypes
    (
        rhoReactionThermo,
        incompressibleGas9EThermoPhysics
    ...
    makeChemistrySolverTypes(rhoReactionThermo, powerGasEThermoPhysics);
    makeChemistrySolverTypes(rhoReactionThermo, powerGas9EThermoPhysics);
    
    makeChemistrySolverTypes(psiReactionThermo, powerGasEThermoPhysics);
    makeChemistrySolverTypes(psiReactionThermo, powerGas9EThermoPhysics);
