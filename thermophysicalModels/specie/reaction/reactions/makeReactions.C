...
#define makeReactions(Thermo, Reaction)                                        \
    ...
    makeIRNReactions(Thermo, CondensReactionRate)                              \
                                                                               \
...
namespace Foam
{
    ...
    // --------- adding Janaf9
    makeReactions(gas9HThermoPhysics, gas9HReaction)
    makeReactions(incompressibleGas9HThermoPhysics, incompressibleGas9HReaction)
    makeReactions(gas9EThermoPhysics, gas9EReaction)
    makeReactions(incompressibleGas9EThermoPhysics, incompressibleGas9EReaction)
    ...
    makeReactions(powerGasHThermoPhysics, powerGasHReaction)
    makeReactions(powerGas9HThermoPhysics, powerGas9HReaction)
    
    makeReactions(powerGasEThermoPhysics, powerGasEReaction)
    makeReactions(powerGas9EThermoPhysics, powerGas9EReaction)
