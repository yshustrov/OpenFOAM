...
namespace Foam
{
    ...
    makeChemistryReductionMethods(psiReactionThermo, gas9HThermoPhysics);
    makeChemistryReductionMethods
    (
        psiReactionThermo,
        incompressibleGas9HThermoPhysics
    );
    makeChemistryReductionMethods(rhoReactionThermo, gas9HThermoPhysics);
    makeChemistryReductionMethods
    (
        rhoReactionThermo,
        incompressibleGas9HThermoPhysics
    ...
    makeChemistryReductionMethods(psiReactionThermo, gas9EThermoPhysics);
    makeChemistryReductionMethods
    (
        psiReactionThermo,
        incompressibleGas9EThermoPhysics
    );
    makeChemistryReductionMethods(rhoReactionThermo, gas9EThermoPhysics);
    makeChemistryReductionMethods
    (
        rhoReactionThermo,
        incompressibleGas9EThermoPhysics
    ...
    makeChemistryReductionMethods(rhoReactionThermo, powerGasHThermoPhysics);
    makeChemistryReductionMethods(rhoReactionThermo, powerGas9HThermoPhysics);
    
    makeChemistryReductionMethods(psiReactionThermo, powerGasHThermoPhysics);
    makeChemistryReductionMethods(psiReactionThermo, powerGas9HThermoPhysics);
    
    //
    makeChemistryReductionMethods(rhoReactionThermo, powerGasEThermoPhysics);
    makeChemistryReductionMethods(rhoReactionThermo, powerGas9EThermoPhysics);
    
    makeChemistryReductionMethods(psiReactionThermo, powerGasEThermoPhysics);
    makeChemistryReductionMethods(psiReactionThermo, powerGas9EThermoPhysics);
