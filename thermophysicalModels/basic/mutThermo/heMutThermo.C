...
void Foam::heMutThermo<BasicMutThermo, MixtureType>::calculate
(
...
template<class BasicMutThermo, class MixtureType>
Foam::heMutThermo<BasicMutThermo, MixtureType>::heMutThermo
(
    const fvMesh& mesh,
    const word& phaseName
)
:
    heThermo<BasicMutThermo, MixtureType>(mesh, phaseName)
{
    calculate
    (
        this->p_,
...
:
    heThermo<BasicMutThermo, MixtureType>(mesh, phaseName, dictionaryName)
{
    calculate
    (
        this->p_,
...
template<class BasicMutThermo, class MixtureType>
void Foam::heMutThermo<BasicMutThermo, MixtureType>::correct()
{
